...
class Student:
    def __init__(self,root):
        ...
        self.text = ''
        self.color = "#4f4e4d"
        self.heading = Label(self.root, text=self.txt, font=("Roboto", 28, "bold"), bg="white", fg="black",
                             bd=5, relief=FLAT)
        ...
        class_student_frame.place(x=5, y=155, width=720, height=400)
        ...
        # --------------------------right_label-------------------------
        Right_frame = LabelFrame(main_frame,bg="white",
                                font=("times new roman", 12, "bold"))
        Right_frame.place(x=745, y=10, width=503, height=330)


        #Search_frame
        search_frame = LabelFrame(Right_frame, bg="white", relief=RIDGE, text="Hệ Thống Tìm kiếm",
                                         font=("times new roman", 12, "bold"))
        search_frame.place(x=3, y=5, width=490, height=70)

        self.var_com_search= StringVar()


        search_combo = ttk.Combobox(search_frame, font=("times new roman", 12, "bold"), state="readonly",
                                      width=11,textvariable=self.var_com_search)
        ...
        search_btn = Button(search_frame, text="Tìm kiếm", font=("times new roman", 9, "bold"),bg="#38a6f0", fg="white", width=12,command=self.search_data)
        search_btn.grid(row=0, column=3,padx=3)

        showAll_btn = Button(search_frame, text="Xem tất cả", font=("times new roman", 9, "bold"), bg="#38a6f0", fg="white",
        ...
        table_frame.place(x=5, y=85, width=490, height=230)
        ...
        #                               font=("times new roman", 12, "bold"))
        # Underright_frame.place(x=750, y=345, width=505, height=310)
        #
        # label_studentsb = Label(Underright_frame, bg="white", fg="red2", text="Quản lý lớp học",
        #                         font=("times new roman", 14, "bold"))
        # label_studentsb.place(x=0, y=1, width=490, height=35)
        #
        # # search
        ...
        # tablestd_frame.place(x=150, y=40, width=200, height=260)
        #
        # # scroll bar
            ...
            if self.var_com_search.get() == "" or self.var_search.get() == "":
                ...
                try:
                    ...
                    my_cursor.execute("select * from student where " + str(
                        search) + " Like '%" + str(self.var_search.get()) + "%'")
                    data = my_cursor.fetchall()
                    if (len(data) != 0):
                        self.student_table.delete(*self.student_table.get_children())
                        for i in data:
            ...
            if self.var_com_searchclass.get() == "" or self.var_searchclass.get() == "":
                ...
                try:
                    ...
                    if (self.var_com_searchclass.get() == "Lớp"):
                        ...
                        self.var_com_searchclass.set("Tên lớp")
