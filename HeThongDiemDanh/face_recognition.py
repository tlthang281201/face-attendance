...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        heading = Label(bg_img, text="Hệ thống điểm danh khuôn mặt", font=("times new roman", 17, "bold"), bg="white",
                        fg="red2",
                        bd=0, relief=FLAT)
        heading.place(x=400, y=20, width=650, height=30)
        ...
        self.notify_frame = LabelFrame(Left_frame, bd=1, bg="white", relief=RIDGE,
                                       font=("times new roman", 11, "bold"))
        self.notify_frame.place(x=8, y=450, width=770, height=60)
        ...
        img_btn1 = img_btn1.resize((300, 45), PIL.Image.ANTIALIAS)
        ...
        self.btnClose.place(x=420, y=620, width=300, height=45)


        #Right_frame
        self.Right_frame = LabelFrame(self.root, bd=2, bg="white", relief=RIDGE, text="Điểm danh thành công",
                                font=("times new roman", 12, "bold"))
        self.Right_frame.place(x=850, y=70, width=420, height=400)
        ...
        self.RightU_frame = LabelFrame(self.root, bd=2, bg="white", relief=RIDGE, text="Thông tin buổi học",
                                      font=("times new roman", 12, "bold"))
        self.RightU_frame.place(x=850, y=480, width=420, height=180)

        #Class
        self.className_label = Label(self.RightU_frame, text="Lớp tín chỉ:",
                                     font=("times new roman", 12, "bold"), bg="white")
        self.className_label.grid(row=0, column=0, padx=10, pady=15, sticky=W)

        self.className_atten_label = Label(self.RightU_frame, text="", font=("times new roman", 12, "bold"),
                                           bg="white",fg="red2")
        self.className_atten_label.grid(row=0, column=1, padx=10, pady=15, sticky=W)

        # subject/lesson
        self.subject_lesson_label = Label(self.RightU_frame, text="Tên môn học/ID Buổi học:",
                                       font=("times new roman", 12, "bold"),
                                       bg="white")
        self.subject_lesson_label.grid(row=1, column=0, padx=10, pady=15, sticky=W)

        self.subject_lesson_atten_label = Label(self.RightU_frame, text="", font=("times new roman", 12, "bold"),
                                             bg="white",fg="red2")
        self.subject_lesson_atten_label.grid(row=1, column=1, padx=10, pady=15, sticky=W)

        # Time
        self.classtime_label = Label(self.RightU_frame, text="Thời gian:",
                                        font=("times new roman", 12, "bold"),
                                        bg="white")
        self.classtime_label.grid(row=2, column=0, padx=10, pady=15, sticky=W)

        self.classtime_atten_label = Label(self.RightU_frame, text="",
                                              font=("times new roman", 12, "bold"),
                                              bg="white",fg="red2")
        self.classtime_atten_label.grid(row=2, column=1, padx=10, pady=15, sticky=W)
    ...
    def face_recog(self):
            ...
            def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
                ...
                for(x,y,w,h) in features:
                    ...
                    if confidence>77:
                        cv2.putText(img,f"ID:{i}",(x,y-30),cv2.FONT_ITALIC,0.8,(255,255,255),2)
                        cv2.putText(img, f"Name:{n}", (x, y - 5), cv2.FONT_ITALIC, 0.8, (255, 255, 255), 2)
