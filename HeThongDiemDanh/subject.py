...
class Subject:
    def __init__(self,root):
        ...
        img3 = img3.resize((1350, 690), PIL.Image.ANTIALIAS)
        ...
        self.count = 0
        self.text = ''
        self.heading = Label(self.root, text=self.txt, font=("times new roman", 28, "bold"), bg="white", fg="black",
                             bd=5, relief=FLAT)
        self.heading.place(x=400, y=22, width=650)

        main_frame = Frame(bg_img, bd=2, bg="white")
        main_frame.place(x=23, y=90, width=1300, height=580)

        # ===================left_label=====================
        self.getNextid()
        Left_frame = LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE,
                                font=("times new roman", 12, "bold"))
        Left_frame.place(x=0, y=3, width=1290, height=320)

        label_Update_att = Label(Left_frame, bg="white", fg="red2", text="Thông tin môn học",
                                 font=("times new roman", 16, "bold"))
        label_Update_att.place(x=0, y=1, width=300, height=42)

        left_inside_frame = Frame(Left_frame, bd=1, bg="white")
        left_inside_frame.place(x=0, y=40, width=1270, height=250)

        # id
        auttendanceID_label = Label(left_inside_frame, text="ID Môn học:",font=("times new roman", 12, "bold"),
                                    bg="white")
        auttendanceID_label.grid(row=0, column=0, padx=10, pady=10, sticky=W)
        ...
        auttendanceID_entry.grid(row=0, column=1, padx=0, pady=10, sticky=W)
        ...
        roll_entry = ttk.Entry(left_inside_frame, width=22, textvariable=self.var_subname,
                               font=("times new roman", 12, "bold"))
        roll_entry.grid(row=1, column=1, padx=0, pady=10, sticky=W)
        ...
        nameLabel_entry = ttk.Entry(left_inside_frame, width=22, textvariable=self.var_subclass,
                                    font=("times new roman", 12, "bold"))
        nameLabel_entry.grid(row=2, column=1, padx=0, pady=10, sticky=W)
        ...
        btn_frame.place(x=0, y=140, width=440, height=115)

        add_btn = Button(btn_frame, text="Thêm mới", command=self.add_data, font=("times new roman", 12, "bold"),
                            bg="#38a6f0", fg="white", width=13)
        add_btn.grid(row=9, column=0, pady=5,padx=10)

        delete_btn = Button(btn_frame, text="Xóa", command=self.delete_data,
                            font=("times new roman", 12, "bold"),
                            bg="#38a6f0", fg="white", width=13)
        delete_btn.grid(row=9, column=1, pady=5,padx=10)

        update_btn = Button(btn_frame, text="Cập nhật", command=self.update_data, font=("times new roman", 12, "bold"),
                            bg="#38a6f0", fg="white", width=13)
        update_btn.grid(row=10, column=0, pady=5, padx=10)

        reset_btn = Button(btn_frame, text="Làm mới", command=self.reset_data, font=("times new roman", 12, "bold"),
                           bg="#38a6f0", fg="white", width=13)
        reset_btn.grid(row=10, column=1, pady=5,padx=10)

        # ==================right_ label========================
        Right_frame = LabelFrame(Left_frame, bg="white",bd=0,
                                 font=("times new roman", 12, "bold"))
        Right_frame.place(x=350, y=0, width=930, height=300)
        ...
        table_frame.place(x=0, y=5, width=320, height=300)

        # scroll bar
        scroll_x = ttk.Scrollbar(table_frame, orient=HORIZONTAL)
        scroll_y = ttk.Scrollbar(table_frame, orient=VERTICAL)

        self.AttendanceReportTable = ttk.Treeview(table_frame, column=("id", "name", "class"),xscrollcommand=scroll_x.set, yscrollcommand=scroll_y.set)
        ...
        self.AttendanceReportTable.column("class", width=90)
        ...
        Underleft_frame.place(x=0, y=325, width=650, height=250)

        label_teachersb = Label(Underleft_frame, bg="white", fg="red2", text="Môn học giảng dạy của giảng viên",
                                 font=("times new roman", 14, "bold"))
        label_teachersb.place(x=0, y=1, width=620, height=35)
        ...
        teachernLabel_entry.place(x=390, y=70,width=160)
        ...
        subsub_label = Label(Underleft_frame, text="ID Môn học:", font=("times new roman", 12, "bold"),
                           bg="white")
        subsub_label.place(x=70, y=130, width=100)

        subsub_entry = ttk.Entry(Underleft_frame, width=20, textvariable=self.var_subsub,
                               font=("times new roman", 12, "bold"))
        subsub_entry.place(x=180, y=130, width=100)

        #sub_name
        self.var_subjectname = StringVar()
        subjectnameLabel = Label(Underleft_frame, text="Tên MH:", font=("times new roman", 12, "bold"),
                                 bg="white")
        subjectnameLabel.place(x=320, y=130,width=60)

        subjectnameLabel_entry = ttk.Entry(Underleft_frame, width=22, textvariable=self.var_subjectname,
                                           font=("times new roman", 12, "bold"), state="disabled")
        subjectnameLabel_entry.place(x=390, y=130,width=160)

        #btn_frameteacher
        btn_frametc = Frame(Underleft_frame, bg="white",relief=RIDGE)
        btn_frametc.place(x=90, y=170, width=455, height=55)
        ...
        # table_frame
        tabletc_frame = Frame(Right_frame, bd=2, relief=RIDGE, bg="white")
        tabletc_frame.place(x=350, y=5, width=200, height=300)
        ...
        self.TeacherTable = ttk.Treeview(tabletc_frame, column=(
            "teacherid", "subid"),xscrollcommand=scroll_x.set, yscrollcommand=scroll_y.set)
        ...
        Underright_frame = LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE,
                                     font=("times new roman", 12, "bold"))
        Underright_frame.place(x=650, y=325, width=640, height=250)

        label_studentsb = Label(Underright_frame, bg="white", fg="red2", text="Môn học của sinh viên",
                                font=("times new roman", 14, "bold"))
        label_studentsb.place(x=0, y=1, width=620, height=35)
        ...
        studentname_entry.place(x=390, y=70, width=160)
        ...
        subject_name_label = Label(Underright_frame, text="Tên MH:", font=("times new roman", 12, "bold"),
                                  bg="white", width=12)
        subject_name_label.place(x=320, y=130, width=60)

        subject_name_entry = ttk.Entry(Underright_frame, textvariable=self.var_stSubname,
                                      font=("times new roman", 12, "bold"), width=12, state="disabled")
        subject_name_entry.place(x=390, y=130, width=160)

        # btn_framestudent
        btn_framestd = Frame(Underright_frame, bg="white", relief=RIDGE)
        btn_framestd.place(x=90, y=170, width=455, height=55)
        ...
        # table_frame
        tablestd_frame = Frame(Right_frame, bd=2, relief=RIDGE, bg="white")
        tablestd_frame.place(x=590, y=5, width=200, height=300)
    ...
    def getNextid(self):
        conn = mysql.connector.connect(host='localhost', user='root', password='', database='studentmanagement',
                                       port='3307')
    ...
    def add_data(self):
        ...
        if self.var_subid.get()=="Select" or self.var_subclass.get()=="" or self.var_subname.get()=="":
            ...
            try:
                conn = mysql.connector.connect(host='localhost', user='root', password='', database='studentmanagement', port='3307')
                my_cursor=conn.cursor()
                ...
                try:
                    ...
                    if delete > 0:
                        conn = mysql.connector.connect(host='localhost', user='root', password='',
                                                       database='studentmanagement', port='3307')
                        my_cursor = conn.cursor()
